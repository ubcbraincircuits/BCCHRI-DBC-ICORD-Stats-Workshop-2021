...
```{r}
# use our function to do 10 resamples.
...
# for every resample in our matrix. 
...
# Save the "t" value of the output using output$t in a variable named m
m = 
# This m is our bootstrap distribution.  
```
...
# create a percentile bootstrap confidence interval. 
...
# interval.again, use boot.ci and change the type to bca
bca_ci=
