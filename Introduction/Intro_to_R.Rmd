...
Everything you have been reading up to this point has been part of the markdown section of the Rmarkdown file. Now let's actually create a coding section. We are going to create a block of code using three apostrophes and {r}
```{r}
