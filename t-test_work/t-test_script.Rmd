...
# first make some data points to use via the rnorm command
...
tdistr=dt(seq(-5,5,by=.1),n)
plot(seq(-5,5,by=.1),tdistr,type="l",main="t distribution",xlab="",ylab="")

# Let's add a not so random line to represent a theoretical sample mean. 
plot(seq(-5,5,by=.1),tdistr,type="l",main="t distribution",xlab="",ylab="")+abline(v=1.75, col='red')
```
