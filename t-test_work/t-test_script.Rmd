...
#Now lets draw a bunch of points from an idential distribution and see what they look like using the hist function. 
...
plot(seq(-5,5,by=.001),tdistr,type="l",main="t distribution",xlab="t",ylab="Probability Density")+
polygon(c(x[x>=1.75], max(x), 1.75), c(tdistr[x>=1.75], 0, 0), col="red")
##!!!!## Replace the abline with polygon. 
```
