...
# sample will be 10 and the standard deviation will be 2.5 Store this sample in
# a variable called sample
sample = 
...
# let's say our H0 is that the population means are equal.  ie mean(x)=mean(y).  So
...
# Ok now use the t.test to perform a two sample t-test. We do not need to set mu, intead we need to 
# input both samples into t.test(). We also need to specify that the variances of our samples are 
# equal and that we want a "left" or "lesser" t-test. 
